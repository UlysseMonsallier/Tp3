...
bouton_pas_prec = tk.Button(btn_frame, text="Pas précédent", command=Main.pas_precedent)
bouton_pas_prec.grid(row=1, column=0, sticky="we", pady=2)

bouton_pas_suiv = tk.Button(btn_frame, text="Pas suivant", command=Main.pas_suivant)
